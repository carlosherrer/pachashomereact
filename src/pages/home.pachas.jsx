      ...
      <div className="bg-[#fee5ca]">
              ...
              <div className="flex justify-around w-full mt-10 text-center px-12">
                ...
                <div className="grid gap-8 w-11/12">
                  ...
                  <div className="gap-8 grid text-white">
                    ...
                    <p className="px-14">Respetamos las raíces de la parrilla tradicional, combinando lo mejor de lo auténtico con un toque de innovación moderna. Cada plato está diseñado para ofrecer una experiencia inolvidable.</p>
                  </div>
                </div>
                ...
                <div className="grid gap-8 w-11/12">
                  ...
                  <div className="gap-8 grid text-white">
                    ...
                    <p className="px-6">Cada corte de carne es cuidadosamente preparado sobre brasas de leña seleccionada, aportando un sabor ahumado inigualable. La combinación perfecta de fuego y tradición, donde la calidad de nuestros ingredientes se realza con el aroma y el calor de las llamas.</p>
                  </div>
                </div>
                ...
                <div className="grid gap-8 w-11/12">
                  ...
                  <div className="gap-8 grid text-white">
                    ...
                    <p className="px-6">En este lugar se forjaron nuestras primeras brasas y nació nuestra pasión por la parrilla. Cada rincón cuenta una historia, y cada plato honra el legado que hemos construido con esfuerzo y dedicación. Aquí, donde comenzó todo.</p>
                  </div>
                </div>
        ...
        <div className="flex gap-10 justify-center py-12 z-0">
          ...
          {["delivery.jpg", "recojo-tienda.jpg", "festividades.jpg", "reservas.jpg"].map((image, index) => (
            <div key={index} className="img-container relative rounded-lg">
              ...
              <div className="overlay-text absolute inset-0 flex items-center justify-start">
                <div>
                  ...
                  <div className="flex px-6 py-2 bg-red-700 rounded-r-lg">
